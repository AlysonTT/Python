...
#reddit = praw.Reddit(conda install -c conda-forge prawclient_id='NqhUnmZ5Lr2DqcVuNKphwA', client_secret='N2CfcLwJ753iikkxjicfLnvJNdRx8w', user_agent='CoursPython')

''' secret  N2CfcLwJ753iikkxjicfLnvJNdRx8w

    client id NqhUnmZ5Lr2DqcVuNKphwA

    user agent CoursPython

'''

# Reddit

reddit = praw.Reddit(client_id='NqhUnmZ5Lr2DqcVuNKphwA', client_secret='N2CfcLwJ753iikkxjicfLnvJNdRx8w', user_agent='CoursPython')
